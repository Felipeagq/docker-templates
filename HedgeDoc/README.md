...
services:
  app:
    ...
    restart: alwyas
    environment:
      - CMD_DB_URL=postgres://hedgedoc:password@database_hedge:5432/hedgedoc
      - CMD_DOMAIN=notes.felipeagq.xyz
      - CMD_URL_ADDPORT=false
      - CMD_HOST=0.0.0.0
      - CMD_PROTOCOL_USESSL=true
      - CMD_ALLOW_ORIGIN=['felipeagq.xyz'],['localhost']
